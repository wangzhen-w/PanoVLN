...
from src.eval.analyze_results import TARGET_KEYS, summarize_rows
...
def resolve_actions_per_replan(
    ...
    return validate_action_count(actions_per_replan)
...
def parse_actions_per_replan(value):
    if value == "uncertainty":
        return value
    try:
        return validate_action_count(value)
...
def select_actions_for_replan(
    ...
    actions_per_replan = validate_action_count(actions_per_replan)
...
def parse_action_sequence(output: str):
