...
# 主输出配置
RAW_ANNOTATIONS="./data/general_VLN_data/ScaleVLN_total/annotations/R2R_scalevln_ft_aug_enc.json"  # 原始离散 ScaleVLN annotation。
EXISTING_SUBSET="./data/general_VLN_data/ScaleVLN_150k/scalevln_subset_150k.json.gz"  # 去重用的官方 150k 子集。
CONNECTIVITY_DIR="./data/general_VLN_data/ScaleVLN_total/connectivity"  # HM3D connectivity。
CONNECTIVITY_MP3D_DIR="./data/general_VLN_data/ScaleVLN_total/connectivity_mp3d"  # MP3D connectivity。
SCENES_DIR="./data/scene"  # Habitat 场景统一根目录。
CONFIG_PATH="${REPO_ROOT}/config/vln_scalevln.yaml"  # GT 回放使用的 Habitat 配置。
OUTPUT_ROOT="./data/general_VLN_data/ScaleVLN_CE"
