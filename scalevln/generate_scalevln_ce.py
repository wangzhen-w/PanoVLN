...
DEFAULT_RAW_ANNOTATIONS = (
    "./data/general_VLN_data/ScaleVLN_total/annotations/"
    "R2R_scalevln_ft_aug_enc.json"
)
DEFAULT_EXISTING_SUBSET = (
    "./data/general_VLN_data/ScaleVLN_150k/"
    "scalevln_subset_150k.json.gz"
)
DEFAULT_CONNECTIVITY_DIR = (
    "./data/general_VLN_data/ScaleVLN_total/connectivity"
)
DEFAULT_CONNECTIVITY_MP3D_DIR = (
    "./data/general_VLN_data/ScaleVLN_total/connectivity_mp3d"
)
DEFAULT_OUTPUT_ROOT = "./data/general_VLN_data/ScaleVLN_CE"
DEFAULT_SCENES_DIR = "./data/scene"
DEFAULT_CONFIG_PATH = "./config/vln_scalevln.yaml"
