...
from transformers import CLIPVisionModel, CLIPImageProcessorPil, CLIPVisionConfig
...
class CLIPVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        self.image_processor = CLIPImageProcessorPil.from_pretrained(self.vision_tower_name)
