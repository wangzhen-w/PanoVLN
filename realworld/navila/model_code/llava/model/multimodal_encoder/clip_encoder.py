...
import torch
from transformers import CLIPImageProcessorPil, CLIPVisionModel, PretrainedConfig
...
class CLIPVisionTower(VisionTower):
    def __init__(self, model_name_or_path: str, config: PretrainedConfig):
        ...
        self.image_processor = CLIPImageProcessorPil.from_pretrained(model_name_or_path)
        self.vision_tower = CLIPVisionModel.from_pretrained(model_name_or_path, dtype=eval(config.model_dtype))
        self.is_loaded = True
