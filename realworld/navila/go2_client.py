...
from realworld.navila.client_config import config_arguments
from realworld.navila.camera_projection import (
    PerspectiveProjector, DEFAULT_PERSPECTIVE_HFOV,
    DEFAULT_PERSPECTIVE_WIDTH, DEFAULT_PERSPECTIVE_HEIGHT,
)
from realworld.navila.navigation_metrics import NavigationMetrics, build_navigation_reports
from realworld.navila.action_policy import (
    ATOMIC_ACTION_NAMES,
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run NaVILA on a Unitree Go2.")
    ...
    parser.add_argument("--method-name", default="NaVILA", help="Method label for experiment aggregation.")
    ...
    try:
        ...
        if args.actions_per_replan == "uncertainty":
            if ready.get("supports_action_uncertainty") is not True:
                raise ValueError("Model server lacks action uncertainty support; update and restart realworld.navila.server")
