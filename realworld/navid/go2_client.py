...
from realworld.navid.client_config import config_arguments
from realworld.navid.camera_projection import (
    PerspectiveProjector, DEFAULT_PERSPECTIVE_HFOV,
    DEFAULT_PERSPECTIVE_WIDTH, DEFAULT_PERSPECTIVE_HEIGHT,
)
from realworld.navid.navigation_metrics import NavigationMetrics, build_navigation_reports
from realworld.navid.action_policy import (
    ATOMIC_ACTION_NAMES,
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run NaVid on a Unitree Go2.")
    ...
    parser.add_argument("--method-name", default="NaVid", help="Method label for experiment aggregation.")
    ...
    try:
        ...
        if args.actions_per_replan == "uncertainty":
            if ready.get("supports_action_uncertainty") is not True:
                raise ValueError("Model server lacks action uncertainty support; update and restart realworld.navid.server")
