...
from transformers import CLIPImageProcessorPil, CLIPVisionConfig
...
class EVAVisionTowerLavis(nn.Module):
    def __init__(self, vision_tower, image_processor, args, use_checkpoint=False, drop_path_rate=0.0, delay_load=False, dtype=torch.float32):
        ...
        if getattr(args, "vision_tower_from_checkpoint", False):
    ...
    def load_model(self, load_weights=True):
        self.image_processor = CLIPImageProcessorPil.from_pretrained(self.image_processor_name)
        ...
        if load_weights:
            state_dict = torch.load(self.vision_tower_name, map_location="cpu", weights_only=True)
    ...
    def forward(self, images):
        ...
        # print("image_features.grad", image_features.grad)
