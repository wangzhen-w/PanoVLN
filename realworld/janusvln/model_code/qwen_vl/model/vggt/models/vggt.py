...
from qwen_vl.model.vggt.heads.camera_head import CameraHead
from qwen_vl.model.vggt.heads.dpt_head import DPTHead
from qwen_vl.model.vggt.heads.track_head import TrackHead
...
class VGGT(nn.Module, PyTorchModelHubMixin):
    ...
    def inference(self, frames, query_points: torch.Tensor = None, past_key_values=None):
        ...
        output = VGGTOutput(ress=all_ress, views=processed_frames)
        return output
