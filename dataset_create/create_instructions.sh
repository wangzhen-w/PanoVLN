...
TRAJECTORIES="./data/general_vln_dataset/panovln/trajectory/trajectories.json.gz"
SCENE_ROOT="./data/scene/hm3d"
OUTPUT_ROOT="./data/general_vln_dataset/panovln"
NAME="train"
ERP_ROOT="./data/images/panovln"
